...
/* harmony import */ var _authinterceptor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./authinterceptor */ 1481);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        ...
        providers: [
            ...
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__.HTTP_INTERCEPTORS, useClass: _authinterceptor__WEBPACK_IMPORTED_MODULE_2__.AuthInterceptor, multi: true },
        ],
...
/* harmony import */ var src_services_user_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/services/user.service */ 2996);
/* harmony import */ var src_services_shared_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/services/shared.service */ 4255);
...
let AuthInterceptor = class AuthInterceptor {
  constructor(auth, router, sharedService) {
    this.auth = auth;
    this.router = router;
  ...
  intercept(req, next) {
    try {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(this.auth.getAuthorizationToken()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(authToken => {
        const authReq = req.clone({
          headers: req.headers.set('Authorization', 'Bearer ' + authToken)
        });
        return next.handle(authReq).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.tap)(event => {
          if (event instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_6__.HttpResponse) {}
        }, /*#__PURE__*/function () {
          var _ref = (0,D_P_s_NODE_JS_NODE_JS_AUTH_FRONT_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (error) {});
...
AuthInterceptor.ctorParameters = () => [{
  ...
  type: src_services_shared_service__WEBPACK_IMPORTED_MODULE_2__.SharedService
}];

AuthInterceptor = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.Injectable)()], AuthInterceptor);
...
let SharedService = class SharedService {
  constructor(toastCtrl, loadingCtrl, popoverController) {
  ...
  showLoading(msg, interval = 120000) {
    var _this = this;
    ...
    return (0,D_P_s_NODE_JS_NODE_JS_AUTH_FRONT_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      return yield _this.loadingCtrl.create({
        message: msg,
        duration: interval
      }).then(load => {
        load.present().then(() => {
  ...
  dismissLoading() {
    ...
    return (0,D_P_s_NODE_JS_NODE_JS_AUTH_FRONT_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      return yield _this2.loadingCtrl.dismiss(null, undefined);
    })();
  }

  showToast(message, col = 'success', timer) {
    var _this3 = this;
    ...
    return (0,D_P_s_NODE_JS_NODE_JS_AUTH_FRONT_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this3.toast = yield _this3.toastCtrl.create({
        message,
        buttons: [{
          role: 'cancel',
          text: 'OK'
...
SharedService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
})], SharedService);
...
let UserService = class UserService {
  ...
  getAuthorizationToken() {
    ...
    return (0,D_P_s_NODE_JS_NODE_JS_AUTH_FRONT_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return yield _this.storage.get('token');
    })();
  }
...
UserService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
})], UserService);
